...
import numpy as np
import math
from ComputeRBF_obj import ComputeRBF_obj

def Minimize_Merit_Function_rbf(data, CandPoint, NumberNewSamples,w_r):
    ...
    CandValue, NormValue = ComputeRBF_obj(CandPoint, data)
